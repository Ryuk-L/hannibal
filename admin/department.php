...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"]) && !empty($_POST["department"])) {
        $departmentValue = $_POST["department"];
        $query = "INSERT INTO departments (department_value) VALUES (?)";
        $statement = $conn->prepare($query);        
        $statement->bind_param("s", $departmentValue);    
        $statement->execute();
    }
    ?>
  ...
  <div class="content  ">
    ...
    <div class="form">
        ...
        <form  method="post">
                        <div class="mb-6">
                            <label for="department"  class="block mb-4 text-sm font-medium text-gray-900 dark:text-white" style="color: #86c232;">create department </label>
